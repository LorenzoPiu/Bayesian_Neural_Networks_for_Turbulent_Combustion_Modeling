...
parser.add_argument('--dropout_prob', type=float, default=0.03, help='Dropout probability')
...
# %% Build model folder
model_folder = build_model_folder(architecture='MCD_NLL', 
                   input_dim=input_dim, 
                   n_neurons=n_neurons,
                   n_layers=n_layers,
...
t = time.time()
model.fit_bayes(data, epochs=n_epochs, batch_size=batch_size, n_samples=n_samples)
t = time.time() - t
